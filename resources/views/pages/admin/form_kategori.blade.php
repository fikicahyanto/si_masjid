...
<div class="blank-page">
	...
	<div class="tab-pane active" id="horizontal-form">
		...
		<form class="form-horizontal" method="Post" action="{{ url('/administrator/kategori/tambah') }}">

			{!! csrf_field() !!}
			<div class="form-group">
				<label for="kategori" class="col-sm-2 control-label label-input-sm">Kateogeri</label>
				<div class="col-sm-8">
					<input type="text" class="form-control1 input-sm" id="judul" placeholder="Kategori..." name="kategori">
				</div>
			</div>
